...
public class ControladorTablaVideojuegos {
    ...
    /* La columna de la cantidad en inventario. */
    @FXML private TableColumn<Videojuego, Number> columnaCantidad;
    /* La columna del precio. */
    @FXML private TableColumn<Videojuego, Number> columnaPrecio;
    /* La columna del año de lanzamiento. */
    @FXML private TableColumn<Videojuego, Number> columnaAño;
    ...
    @FXML private void initialize() {
        ...
        columnaCantidad.setCellValueFactory(c -> c.getValue().cantidadProperty());
